...
extern int8_t correctionSoftLaunch(int8_t advance, statuses &current, const config2 &page2, const config6 &page6, const config10 &page10);
...
static void setup_correctionSoftLaunch(soft_launch_data_t &testData) {
    ...
    testData.page10.lnchCtrlVss = 50;
    testData.page2.vssMode = 2;    
...
static void test_correctionSoftLaunch_on(void) {
    ...
    TEST_ASSERT_EQUAL(testData.page6.lnchRetard, correctionSoftLaunch(-8, testData.current, testData.page2, testData.page6, testData.page10));
...
static void test_correctionSoftLaunch_off_disabled(void) {
    ...
    TEST_ASSERT_EQUAL(-8, correctionSoftLaunch(-8, testData.current, testData.page2, testData.page6, testData.page10));
...
static void test_correctionSoftLaunch_off_vsslimit(void) {
    soft_launch_data_t testData;
    setup_correctionSoftLaunch(testData);
    testData.current.vss = 100; //VSS above limit of 80
