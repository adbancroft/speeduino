...
void test_Renix_newIgn_44_trig0_1()
{
    ...
    //Advance: 10
    //triggerAngle=0
    decoder_t decoder = test_setup_renix44();
    configPage4.sparkMode = IGN_MODE_SINGLE;
    calculateIgnitionAngles(ignitionSchedules[0], 0, 10); //Set 10 degrees advance
...
void test_Renix_newIgn_66_trig0_2()
{
    ...
    //Advance: 10
    //triggerAngle=300
    decoder_t decoder = test_setup_renix66();
    configPage4.sparkMode = IGN_MODE_SINGLE;
    calculateIgnitionAngles(ignitionSchedules[0], 0, 10); //Set 10 degrees advance
    configPage4.triggerAngle = 0; //No trigger offset
