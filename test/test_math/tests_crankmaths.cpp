...
void test_crankmaths_angletotime_revolution_execute() {
  ...
  setRevolutionTime(testdata->revolutionTime, currentStatus);
...
void testCrankMaths()
{
  SET_UNITY_FILENAME() {  
    ...
    const crankmaths_rev_testdata crankmaths_rev_testdatas[] = {
      { .revolutionTime = 1200000, .angle = 0,   .expected = 0 },
      { .revolutionTime = 1200000, .angle = 25,  .expected = 83333 }, // 83333,3333
      { .revolutionTime = 1200000, .angle = 720, .expected = 2400000 },
      { .revolutionTime = 24000,   .angle = 0,   .expected = 0 },
      { .revolutionTime = 24000,   .angle = 25,  .expected = 1667 }, // 1666,6666
      { .revolutionTime = 24000,   .angle = 720, .expected = 48000 },
      { .revolutionTime = MIN_REVOLUTION_TIME,    .angle = 0,   .expected = 0 },
      { .revolutionTime = MIN_REVOLUTION_TIME,    .angle = 25,  .expected = 231 }, // 208,3333
      { .revolutionTime = MIN_REVOLUTION_TIME,    .angle = 720, .expected = 6666 },
      { .revolutionTime = MAX_REVOLUTION_TIME-1,    .angle = 0,   .expected = 0 },
      { .revolutionTime = MAX_REVOLUTION_TIME-1,    .angle = 25,  .expected = 101626 }, // 208,3333
      { .revolutionTime = MAX_REVOLUTION_TIME-1,    .angle = 720, .expected = 2926825 }
    };

    for (auto testdata : crankmaths_rev_testdatas) {
      crankmaths_rev_testdata_current = &testdata;
      snprintf(testName, testNameLength, "crankmaths/angletotime/revolution/%urpm/%uangle", (unsigned int)(MICROS_PER_MIN/testdata.revolutionTime), testdata.angle);
