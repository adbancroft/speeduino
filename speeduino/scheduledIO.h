...
#if defined(OUTPUT_CONTROL_SUPPORTED)
static inline void coil1Toggle(void)     { if(ignitionOutputControl != OUTPUT_CONTROL_MC33810) { coil1Toggle_DIRECT(); } else { coil1Toggle_MC33810(); } }
static inline void coil2Toggle(void)     { if(ignitionOutputControl != OUTPUT_CONTROL_MC33810) { coil2Toggle_DIRECT(); } else { coil2Toggle_MC33810(); } }
static inline void coil3Toggle(void)     { if(ignitionOutputControl != OUTPUT_CONTROL_MC33810) { coil3Toggle_DIRECT(); } else { coil3Toggle_MC33810(); } }
static inline void coil4Toggle(void)     { if(ignitionOutputControl != OUTPUT_CONTROL_MC33810) { coil4Toggle_DIRECT(); } else { coil4Toggle_MC33810(); } }
static inline void coil5Toggle(void)     { if(ignitionOutputControl != OUTPUT_CONTROL_MC33810) { coil5Toggle_DIRECT(); } else { coil5Toggle_MC33810(); } }
static inline void coil6Toggle(void)     { if(ignitionOutputControl != OUTPUT_CONTROL_MC33810) { coil6Toggle_DIRECT(); } else { coil6Toggle_MC33810(); } }
static inline void coil7Toggle(void)     { if(ignitionOutputControl != OUTPUT_CONTROL_MC33810) { coil7Toggle_DIRECT(); } else { coil7Toggle_MC33810(); } }
static inline void coil8Toggle(void)     { if(ignitionOutputControl != OUTPUT_CONTROL_MC33810) { coil8Toggle_DIRECT(); } else { coil8Toggle_MC33810(); } }
#else
static inline void coil1Toggle(void)     { coil1Toggle_DIRECT(); }
static inline void coil2Toggle(void)     { coil2Toggle_DIRECT(); }
static inline void coil3Toggle(void)     { coil3Toggle_DIRECT(); }
static inline void coil4Toggle(void)     { coil4Toggle_DIRECT(); }
static inline void coil5Toggle(void)     { coil5Toggle_DIRECT(); }
static inline void coil6Toggle(void)     { coil6Toggle_DIRECT(); }
static inline void coil7Toggle(void)     { coil7Toggle_DIRECT(); }
static inline void coil8Toggle(void)     { coil8Toggle_DIRECT(); }
#endif
