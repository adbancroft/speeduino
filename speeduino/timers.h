...
#define TACHO_PULSE_HIGH() { extern ioPort tach_pin_port; setPin_High(tach_pin_port); }
#define TACHO_PULSE_LOW() { extern ioPort tach_pin_port; setPin_Low(tach_pin_port); }
