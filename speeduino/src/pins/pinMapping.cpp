...
static __attribute__((optimize("Os"))) pinNumbers_t getV02ShieldMapping(void)
{
  pinNumbers_t pins;
...
TESTABLE_STATIC __attribute__((optimize("Os"))) pinNumbers_t getDefaultPinMapping(void)
{
...
static __attribute__((optimize("Os"))) pinNumbers_t getV03ShieldMapping(void)
{
  pinNumbers_t pins;
...
static __attribute__((optimize("Os"))) pinNumbers_t getV04ShieldMapping(void)
{
  pinNumbers_t pins;
...
static __attribute__((optimize("Os"))) pinNumbers_t getMiataNB2Mapping(void)
{
  pinNumbers_t pins;
...
static __attribute__((optimize("Os"))) pinNumbers_t getMiataNA18Mapping(void)
{
  pinNumbers_t pins;
...
static __attribute__((optimize("Os"))) pinNumbers_t getMiataNA16Mapping(void)
{
  pinNumbers_t pins;
...
static __attribute__((optimize("Os"))) pinNumbers_t getTurtanasPcbPinMapping(void)
{
  pinNumbers_t pins;
...
static __attribute__((optimize("Os"))) pinNumbers_t getLevinMapping(void)
{
  pinNumbers_t pins;
...
static __attribute__((optimize("Os"))) pinNumbers_t getPlazomatV01Mapping(void)
{
  pinNumbers_t pins;
  pins.setInjectorPin(0, 8);//Output pin injector 1 is on
  pins.setInjectorPin(1, 9);//Output pin injector 2 is on
...
static __attribute__((optimize("Os"))) pinNumbers_t getDazV6V01Mapping(void)
{
  pinNumbers_t pins;
  pins.setInjectorPin(0, 8);//Output pin injector 1 is on
  pins.setInjectorPin(1, 9);//Output pin injector 2 is on
...
static __attribute__((optimize("Os"))) pinNumbers_t getBmwPnPMapping(void)
{
  pinNumbers_t pins;
...
static __attribute__((optimize("Os"))) pinNumbers_t getNO2CMapping(void)
{
  pinNumbers_t pins;
...
static __attribute__((optimize("Os"))) pinNumbers_t getUA4CMapping(void)
{
  pinNumbers_t pins;
...
static __attribute__((optimize("Os"))) pinNumbers_t getBlitzboxBL49spMapping(void)
{
  pinNumbers_t pins;
...
static __attribute__((optimize("Os"))) pinNumbers_t getDIYEFICore4Mapping(void)
{
  pinNumbers_t pins;
...
static __attribute__((optimize("Os"))) pinNumbers_t getDvjCodecMapping(void)
{
  pinNumbers_t pins;
...
static __attribute__((optimize("Os"))) pinNumbers_t getJuiceBoxMapping(void)
{
  pinNumbers_t pins;
...
static __attribute__((optimize("Os"))) pinNumbers_t getDropBearMapping(void)
{
  pinNumbers_t pins;
...
static __attribute__((optimize("Os"))) pinNumbers_t getBearCubMapping(void)
{
  pinNumbers_t pins;
...
static __attribute__((optimize("Os"))) pinNumbers_t getSpectreV05Mapping(void)
{
  pinNumbers_t pins;
#if defined(STM32F407xx)
  //Pin definitions for experimental board Tjeerd 
...
__attribute__((optimize("Os"))) pinNumbers_t getPinMapping(uint8_t boardID)
{
