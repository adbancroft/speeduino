...
static inline __attribute__((always_inline)) uint32_t calculateInjectorTimeout(const FuelSchedule &schedule, int16_t channelInjDegrees, int16_t injectorStartAngle, int16_t crankAngle);
