...
static SCHEDULE_INLINE uint32_t calculateInjectorTimeout(const FuelSchedule &schedule, int16_t channelInjDegrees, int16_t injectorStartAngle, int16_t crankAngle);
