...
void sendValuesLegacy(void)
{
  ...
  bytestosend -= Serial.write(fuelSchedules[0].pw>>8);
  bytestosend -= Serial.write(fuelSchedules[0].pw);
  bytestosend -= Serial.write(fuelSchedules[1].pw>>8);
  bytestosend -= Serial.write(fuelSchedules[1].pw);
