...
uint16_t correctionsDwell(uint16_t dwell)
{
  ...
  */
  ...
  if(dwellPerRevolution > getRevolutionTime())
  {
    //Possibly need some method of reducing spark duration here as well, but this is a start
    uint16_t adjustedSparkDur = udiv_32_16(sparkDur_uS * getRevolutionTime(), dwellPerRevolution);
    tempDwell = udiv_32_16(getRevolutionTime(), (uint16_t)pulsesPerRevolution) - adjustedSparkDur;
  }
