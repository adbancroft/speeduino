 ...
 */
TESTABLE_INLINE_STATIC int8_t correctionSoftLaunch(int8_t advance, statuses &current, const config2 &page2, const config6 &page6, const config10 &page10)
{
  ...
  if(  page6.launchEnabled 
    ...
    && ( (page2.vssMode == VSS_MODE_OFF) || ((page2.vssMode!=VSS_MODE_OFF) && (current.vss <= page10.lnchCtrlVss)) )
    )
  {
...
int8_t correctionsIgn(int8_t base_advance)
{
  ...
  advance = correctionSoftLaunch(advance, currentStatus, configPage2, configPage6, configPage10);
