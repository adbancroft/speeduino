...
#else
void coil1Toggle(void)     { coil1Toggle_DIRECT(); }
void coil2Toggle(void)     { coil2Toggle_DIRECT(); }
void coil3Toggle(void)     { coil3Toggle_DIRECT(); }
void coil4Toggle(void)     { coil4Toggle_DIRECT(); }
void coil5Toggle(void)     { coil5Toggle_DIRECT(); }
void coil6Toggle(void)     { coil6Toggle_DIRECT(); }
void coil7Toggle(void)     { coil7Toggle_DIRECT(); }
void coil8Toggle(void)     { coil8Toggle_DIRECT(); }
#endif
