...
// With no inheritance or virtual functions, we need to identifypass around void*
...
inline axis_domain key_to_xdomain(uint16_t key)
{
    return (axis_domain)((key>>8) & 0x0F);
}
inline axis_domain key_to_ydomain(uint16_t key)
{
