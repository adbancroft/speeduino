...
void doUpdates(void)
{
  ...
  if(loadEEPROMVersion() == 6)
  {
    ...
    static constexpr uint16_t EEPROM_CONFIG10_END_V7 = 2094;
  ...
  if(loadEEPROMVersion() == 16)
  {
    ...
    static constexpr uint16_t EEPROM_CONFIG14_END_V16 = 2998U;
    static constexpr uint16_t EEPROM_CONFIG13_START_V16 = 2580U;
    static constexpr uint16_t SHIFT_DISTANCE = 112U;
