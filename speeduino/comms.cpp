...
namespace {
  ...
  void serial_print_3dtable(table_row_iterator_t row_it, table_axis_iterator_t x_it, table_axis_iterator_t y_it)
  {
    while (!at_end(row_it))
    {
  ...
  #define serial_print_3dtable(table) \
    serial_print_3dtable(rows_begin(&table), x_begin(&table), y_begin(&table));
}
