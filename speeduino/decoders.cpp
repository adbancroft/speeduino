...
void triggerSetEndTeeth_SuzukiK6A(void)
{
  ...
  tempIgnitionEndTooth = (ignitionSchedule1.endAngle - configPage4.triggerAngle);
  ...
  tempIgnitionEndTooth = (ignitionSchedule2.endAngle - configPage4.triggerAngle);
  tempIgnitionEndTooth = ignitionLimits(tempIgnitionEndTooth);
  ...
  tempIgnitionEndTooth = (ignitionSchedule3.endAngle - configPage4.triggerAngle);
  tempIgnitionEndTooth = ignitionLimits(tempIgnitionEndTooth);
