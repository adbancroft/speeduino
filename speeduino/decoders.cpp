...
void triggerSetEndTeeth_SuzukiK6A(void)
{
  ...
  tempIgnitionEndTooth = (ignitionSchedule1.dischargeAngle - configPage4.triggerAngle);
  ...
  tempIgnitionEndTooth = (ignitionSchedule2.dischargeAngle - configPage4.triggerAngle);
  tempIgnitionEndTooth = ignitionLimits(tempIgnitionEndTooth);
  ...
  tempIgnitionEndTooth = (ignitionSchedule3.dischargeAngle - configPage4.triggerAngle);
  tempIgnitionEndTooth = ignitionLimits(tempIgnitionEndTooth);
