...
*/
  ...
  */
  ...
  //#define MAX_TIMER_PERIOD ((65535U * 1000000ULL) / (F_BUS_ACTUAL / TMR_PRESCALE)) //55923 @ 600Mhz. 
    ...
    #define uS_TO_TIMER_COMPARE(uS) ((COMPARE_TYPE)(((uS) * 75UL) >> 6U)) //Converts a given number of uS into the required number of timer ticks until that time has passed. 
  #elif F_CPU == 528000000
    //Bus Clock is 132Mhz @ 528 Mhz CPU.
    #define MAX_TIMER_PERIOD 63549UL //Time per tick = 0.96969696
    #define uS_TO_TIMER_COMPARE(uS) ((COMPARE_TYPE)(((uS) * 66UL) >> 6U)) //Converts a given number of uS into the required number of timer ticks until that time has passed. 
    ...
    #define uS_TO_TIMER_COMPARE(uS) ((COMPARE_TYPE)(((uS) * 75UL) >> 7U)) //Converts a given number of uS into the required number of timer ticks until that time has passed. 
  #else
