...
struct statuses {
  ...
  byte knockRetard;
  bool knockActive;
  byte loggerSelection; // 0 means logger disabled, 1==tooth log, 2 means use secondary input (1st cam), 3 means use tertiary input (2nd cam), 4 means log both cams together
