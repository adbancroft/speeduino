...
extern struct table2D<uint8_t, uint8_t, 10> idleTargetTable; ///< 10 bin idle target table for idle timing (2D)
extern struct table2D<uint8_t, uint8_t, 6> idleAdvanceTable; ///< 6 bin idle advance adjustment table based on RPM difference  (2D)
