...
extern table2du8u8_4 PrimingPulseTable; ///< 4 bin Priming pulsewidth map (2D)
...
extern table2du8u16_4 injectorAngleTable; ///< 4 bin injector angle curve (2D)
...
extern table2du8u8_10 idleTargetTable; ///< 10 bin idle target table for idle timing (2D)
...
extern table2du8u8_8 rotarySplitTable; ///< 8 bin ignition split curve for rotary leading/trailing  (2D)
...
extern table2du8s16_6 flexBoostTable; ///< 6 bin flex fuel correction table for boost adjustments (2D)
extern table2du8u8_6 fuelTempTable;  ///< 6 bin flex fuel correction table for fuel adjustments (2D)
extern table2du8u8_6 knockWindowStartTable;
extern table2du8u8_6 knockWindowDurationTable;
extern table2du8u8_4 oilPressureProtectTable;
extern table2du8u8_6 wmiAdvTable; //6 bin wmi correction table for timing advance (2D)
extern table2du8u8_6 coolantProtectTable;
extern table2du8u8_4 fanPWMTable;
extern table2di8u8_4 rollingCutTable;
...
extern table2du16u16_32 cltCalibrationTable; /**< A 32 bin array containing the coolant temperature sensor calibration values */
extern table2du16u16_32 iatCalibrationTable; /**< A 32 bin array containing the inlet air temperature sensor calibration values */
extern table2du16u8_32 o2CalibrationTable; /**< A 32 bin array containing the O2 sensor calibration values */
